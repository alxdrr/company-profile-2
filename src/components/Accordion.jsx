...
const Accordion = ({ title, content }) => {
  ...
  return (
    <div className="flex flex-col w-full max-w-screen-md shadow-md rounded-3xl bg-white">
      ...
      <div className={` grid px-6 overflow-hidden rounded-b-3xl transition-all duration-300 ease-in-out text-slate-600 ${accordionOpen ? "grid-rows-[1fr] opacity-100 pb-6 pt-3" : "grid-rows-[0fr] opacity-0"}`}>
