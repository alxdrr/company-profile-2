  ...
  return (
    <div className="w-screen bg-primary">
      <div className="flex flex-col justify-center items-center h-max  py-16 px-6 max-w-screen-xl w-full mx-auto text-white gap-8">
        <main className="flex w-full justify-between gap-9">
          <div className="flex flex-col">
            <section className="text-secondary text-xl font-black mb-4">Follow Us</section>
          ...
          <div className="flex flex-col gap-4">
            <section className="text-secondary text-xl font-black">Explore</section>
          ...
          <div className="flex flex-col gap-4">
            <section className="text-secondary text-xl font-black">Contact Us</section>
            <a className="text-white font-normal" href="/">
              +62 821-3875-4680
            </a>
            <a className="text-white font-normal" href="/">
          ...
          <div className="flex flex-col">
            <section className="text-secondary font-black text-xl mb-4">Address</section>
            <p className="text-white font-normal max-w-xs" href="/">
          ...
          <div className="flex flex-col ">
            <a href="forcoms.com" className="w-full">
              <img src={forcomsLogo} alt="forcoms logo" className="w-full h-full max-w-[220px] mx-auto" />
            </a>
            <p className="text-gray-300 italic font-normal text-center text-xl mt-8" href="/">
              Innovate for Growth
            </p>
          </div>
        </main>
